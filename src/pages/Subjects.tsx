...
import { Plus, Trash2, Edit, BookOpen, Clock, User } from 'lucide-react';
...
export default function Subjects() {
  const { subjects, tasks, notes, materials, addSubject, updateSubject, deleteSubject } = useData();
    ...
    <div className="p-6 lg:p-8 space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Organize your courses and study materials</p>
        </div>
        ...
        <Dialog open={isDialogOpen} onOpenChange={(open) => {
          ...
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                {editingSubject ? 'Update subject details.' : 'Add a new subject to organize your studies.'}
              </DialogDescription>
            </DialogHeader>
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <Badge variant="secondary">{stats.notes} note{stats.notes !== 1 ? 's' : ''}</Badge>
                      <Badge variant="secondary">{stats.materials} material{stats.materials !== 1 ? 's' : ''}</Badge>
                    </div>

                    {/* Expanded view */}
                    {selectedSubject?.id === subject.id && subject.syllabus && subject.syllabus.length > 0 && (
                      <div className="pt-3 border-t mt-3 animate-fade-in">
                        <p className="text-sm font-medium mb-2">Syllabus Topics:</p>
